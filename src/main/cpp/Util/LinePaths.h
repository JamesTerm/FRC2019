...
{
    static double Path1[][3] = {{0, 0, 0}, {-1, 0, 0}, {-1.6, 0, 0}, {-2.2, 0, 0}, {-2.8, 0, 0}, {-3.4, 0, 0}, {-4, 0, 0}, {-4.6, 0, 0}, {-5.2, 0, 0}, {-5.8, 0, 1}};
    static double Path2[][3] = {{0, 0, 0}, {1, 1, 0}, {5.8, 5, 0}, {6.4, 5.5, 0}, {8.5, 5.5, 0}, {9, 5.5, 0}, {14, 5.5, 0}, {15, 5, 0}, {15, 4.5, 0}, {15, 4, 1}};
    static double Path3[][3] = {{0, 0, 0}, {1, 1, 0}, {5.8, 5, 0}, {6.4, 5.5, 0}, {8.5, 5.5, 0}, {9, 5.5, 0}, {14, 5.5, 0}, {15, 5, 0}, {15, 4.5, 0}, {15, 4, 1}};
